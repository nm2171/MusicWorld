		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<h3>Welcome back. Please log in to your account and enjoy some good music.<br><br></h3>
					<p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="email2" name="email2" type="email" placeholder="Enter your email again." value="<?php getInputValue('email2') ?>" required>
					</p>
					...
					<p>
						...
						<input id="password" name="password" type="password" placeholder="Create your password." required>
					</p>

					<p>
						<label for="password2">Confirm password</label>
						<input id="password2" name="password2" type="password" placeholder="Type your password again." required>
					</p>
